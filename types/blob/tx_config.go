...
// NOTICE: In gatenode, blob module simply imports state's TxConfig struct and aliases it.
// Here, we have to define the TxConfig struct from scratch to avoid the unnecessary dependency
// for users using gatenode-openrpc in a modular way.
